  ...
  >
    ...
    >
      ...
      <div
        ...
        :key="camera.id"
        class="flex items-stretch group shrink-0"
      >
        <button
          @click="selectCamera(camera.id)"
          class="flex items-center px-4 py-3 text-sm font-medium border-b-2 transition-all whitespace-nowrap gap-2"
          :class="
    ...
    <div class="flex-grow min-h-0 relative overflow-hidden">
      ...
      >
        ...
        <div>
          <h2 class="text-xl font-bold text-white mb-2">Keine Kameras konfiguriert</h2>
          <p class="text-gray-400 text-sm">Klicke auf „+ Kamera" in der Tab-Leiste.</p>
        </div>
      </div>
    </div>
